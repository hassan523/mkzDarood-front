...
// ─── Main Modal ───────────────────────────────────────────────────────────────
const DeleteDaroodModal: React.FC<DeleteAccountModalProps> = ({ visible, onClose, onConfirm, isLoading = false, requireConfirmText = true }) => {
                    ...
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ width: '100%' }}>
                         <Animated.View style={[styles.sheet, { height: isKeyboardOpen ? '95%' : 'auto', transform: [{ translateY: sheetTranslateY }] }]}>
                              ...
                              <Animated.View style={[styles.textBlock, { opacity: warningOpacity }]}>
                                   <Text style={styles.title}>Delete Darood</Text>
                              ...
                              <Animated.View style={[styles.warningBox, { opacity: warningOpacity }]}>
                                   {['Your Darood will be permanently deleted'].map((item, i) => (
...
export default DeleteDaroodModal;
